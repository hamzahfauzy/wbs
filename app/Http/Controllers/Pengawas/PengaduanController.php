...
class PengaduanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pengawas.pengaduan.index',compact('pengaduans','filter'));
    }
    ...
    {
        //
        return view('pengawas.pengaduan.show',compact('pengaduan'));
    }
    ...
    public function updateStatus(Pengaduan $pengaduan, $status)
    {
        ...
        return redirect()->route('pengawas.pengaduan.show',$pengaduan->id)->with('success','Pengaduan berhasil di update');
    }
